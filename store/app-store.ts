...
interface AppStore {
  ...
  currentUser: { name: string; email: string; company: string; salesPitch?: string; targetCustomers?: string; aiEmailInstructions?: string } | null;
  setCurrentUser: (user: { name: string; email: string; company: string; salesPitch?: string; targetCustomers?: string; aiEmailInstructions?: string } | null) => void;
